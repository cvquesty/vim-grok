...
command! -range -nargs=0 GrokExplain  call grok#explain(<line1>, <line2>, <count>)
command! -range -nargs=0 GrokRefactor call grok#refactor(<line1>, <line2>, <count>)
command! -range -nargs=0 GrokReview   call grok#review(<line1>, <line2>, <count>)
command! -range -nargs=0 GrokFix      call grok#fix(<line1>, <line2>, <count>)
